...
const Button = ({
  ...
  const base =
    "inline-flex items-center justify-center rounded-xl text-sm font-semibold transition-all focus-visible:outline-none disabled:opacity-50 shadow-sm";
  const variants = {
...
const Label = ({ className = "", children, icon: Icon, ...props }) => (
  <label
    className={`text-sm font-semibold leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-slate-700 flex items-center gap-2 mb-2 ${className}`}
    {...props}
  >
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            <div className="flex items-center justify-between">
              <Label htmlFor="password" icon={Lock}>
                Password
              </Label>
              <button
                type="button"
